<?php
    ...
    $sql2 = "SELECT * FROM tickets WHERE ticket_holder_id = $user_id";
    ...
    <div class="concert-tickets">
        ...
        ?>
                <div class="event-ticket">
                    ...
                    ?>                     
                    <div class="event-name"><?= $concert['concert_name'] ?></div>
                    <div class="event-date"><?= $concert['date'] ?></div>
                    <div class="event-time"><?= $concert['time'] ?></div>
                    <div class="event-price"><?= $concert['event_price'] ?></div>
                </div>
        <?php
                }
            } else {
